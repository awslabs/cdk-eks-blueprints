...
| [`NewRelicAddOn`](./newrelic.md)                                               |                                                                             Adds [New Relic](https://newrelic.com/) and [Pixie](https://px.dev/) observability for Amazon EKS.                                                                             |      ✅      |
...
| [`Union`](./union.md)                                                          |                                                                   Adds [Amazon SSM Agent](https://docs.aws.amazon.com/systems-manager/latest/userguide/ssm-agent.html) to worker nodes.                                                                    |      ✅      |
